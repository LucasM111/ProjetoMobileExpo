...
import { toPromise as l, take as h, filter as y, subscribe as k, map as m, tap as x, merge as g, mergeMap as E, takeUntil as w, make as O, onPush as N, share as b, fromPromise as _, fromValue as q, makeSubject as D, lazy as S, onStart as P, switchMap as V, publish as R, takeWhile as A, onEnd as M } from "wonka";
...
var cacheExchange = ({forward: e, client: r, dispatchDebug: t}) => {
  ...
  return o => {
    ...
    var s = x((e => {
      ...
      cacheOutcome: "miss"
    }) : e))(g([ m(mapTypeNames)(y((e => !shouldSkip(e) && !isOperationCached(e)))(o)), y((e => shouldSkip(e)))(o) ])))));
    return g([ i, s ]);
  };
};
...
var mapExchange = ({onOperation: e, onResult: r, onError: t}) => ({forward: n}) => a => E((e => {
  if (t && e.error) {
...
var C = function Client(e) {
  ...
  var makeResultSource = r => {
    ...
    if ("query" !== r.kind) {
      ...
      i = V((e => {
        var t = q(e);
        return e.stale || e.hasNext ? t : g([ t, m((() => {
          e.stale = !0;
          return e;
    ...
    executeRequestOperation(e) {
      ...
      return withPromise(S((() => {
        ...
        if ("query" === e.kind && a && (a.stale || a.hasNext)) {
          return V(q)(g([ r, y((r => r === t.get(e.key)))(q(a)) ]));
        } else {
          return r;
        }
      })));
  ...
  var E = composeExchanges(e.exchanges);
  var O = b(E({
    client: p,
    dispatchDebug: d,
